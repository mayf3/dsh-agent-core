#!/bin/bash
# =============================================================================
# scheduler-self-healing-deploy-v4.sh — SCHEDULER_SELF_HEALING_FROM_FEISHU_V1
# Phase C authorized deployment (EXACTLY_ONCE, Owner authorization 2026-09-18,
# target 41f354d163f532348b2ad1ef33b5ee528655dfc6). V3 supersedes v2 (v2 never
# executed; superseded for two guaranteed-false-fail gates found in review:
# W2-heartbeat path and package.json whole-file equality — see FREEZE_V3.md).
#
...
#
# Usage (root, single line): see FREEZE_V4.md §Execution.
...
STATE_ROOT="/usr/local/var/agent-core/scheduler-self-healing-v4"
RECEIPT_ROOT="$STATE_ROOT/receipts"
RB_TMP="/private/tmp/scheduler-self-healing-deploy-v4-receipt"
AUTH_MARKER="$RECEIPT_ROOT/deploy-v4.auth"
...
# ---- APPLY (exactly once) ------------------------------------------------------
say "ALL PREFLIGHT GATES PASS — applying frozen packet V4"
...
cp "$RB_TMP/deploy-receipt.txt" "$RECEIPT_ROOT/scheduler-self-healing-deploy-v4.receipt" 2>/dev/null || true
