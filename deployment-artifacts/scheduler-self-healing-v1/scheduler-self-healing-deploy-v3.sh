#!/bin/bash
# =============================================================================
# scheduler-self-healing-deploy-v3.sh — SCHEDULER_SELF_HEALING_FROM_FEISHU_V1
...
STATE_ROOT="/usr/local/var/agent-core/scheduler-self-healing-v2"
RECEIPT_ROOT="$STATE_ROOT/receipts"
RB_TMP="/private/tmp/scheduler-self-healing-deploy-v3-receipt"
AUTH_MARKER="$RECEIPT_ROOT/deploy-v3.auth"
