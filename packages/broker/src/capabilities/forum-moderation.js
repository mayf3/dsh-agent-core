/**
 * @agent-core/broker — Forum moderator capability manifests (V2).
 *
 * Pure manifest data for the closed moderator pack. Registration is gated by
 * the configured moderator Agent id list in the Broker plugin.
 */
...
export const moderatorScopes = ['forum.read', 'forum.write', 'forum.moderate']
...
export const forumAdminUnreadManifest = withTransportErrors({
  ...
  description:
    ...
    'across agents (deployed admin plane guards with forum.moderate). ' +
