/**
 * AGENT_CORE_SELF_SERVICE_SCHEDULER_TOOLS_V2 input schema/normalization and
 * failure-mapping layer (AMENDMENT_3 structure closure — split from
 * self-service.js; behavior byte-equivalent, CTR-AUTH consumption unchanged
 * except the AMENDMENT_1 logicalKey exception documented in AMENDMENT_2 B1).
 */
...
export function currentConversationDestination(context) {
