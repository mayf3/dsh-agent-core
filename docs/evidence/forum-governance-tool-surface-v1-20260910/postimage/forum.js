...
// DEPLOYMENT COMPOSITION (FORUM_GOVERNANCE_TOOL_SURFACE_V1 activation): the
// production broker src/index.js (incident-overlay owned, untouched by this
// closure) consumes only the `manifests` export — compose every normal pack
// into it. The source-repo shape (manifests = first batch only) lives in
// dsh-agent-core main; this variant retires when the production index.js is
// next rebased onto main (V2 packet §A / post-PR-#222).
export const manifests = [...firstBatchManifests, ...normalManifests]
