#!/bin/bash
# =============================================================================
# scheduler-self-healing-deploy-v5.sh — SCHEDULER_SELF_HEALING_FROM_FEISHU_V1
...
STATE_ROOT="/usr/local/var/agent-core/scheduler-self-healing-v5"
RECEIPT_ROOT="$STATE_ROOT/receipts"
RB_TMP="/private/tmp/scheduler-self-healing-deploy-v5-receipt"
AUTH_MARKER="$RECEIPT_ROOT/deploy-v5.auth"
...
# ---- APPLY (exactly once) ------------------------------------------------------
say "ALL PREFLIGHT GATES PASS — applying frozen packet V5"
...
cp "$RB_TMP/deploy-receipt.txt" "$RECEIPT_ROOT/scheduler-self-healing-deploy-v5.receipt" 2>/dev/null || true
